...
export const handleFormFieldChange = (setState, name, value) => {
    setState((prevState) => {
...
//    }
//};
export const getDateFormatted = (date, format = "dd/MM/yyyy") => {
...
export const getDateFormattedFromDate = (datePass, format = "dd/MM/yyyy") => {
    if (datePass) {
