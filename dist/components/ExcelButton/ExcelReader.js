...
const ExcelReader = ({ manageDataFunction, formik }) => {
    ...
    return (_jsx("div", { className: "text-center", children: _jsx(FileUploaderComponent, { acceptFile: ".xlsx, .xls", labelButton: "Carica Excel", disabled: !formik.values.topic, isRequired: true, name: "file", formik: formik }) }));
};
