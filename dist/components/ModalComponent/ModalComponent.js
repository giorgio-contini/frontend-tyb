...
const ModalComponent = ({ display, element, classCustom, styleCustom }) => {
    ...
    return createPortal(_jsxs("div", { className: `ModalsPortal__wrapper ${display ? "open" : "closed"} ${classCustom}`, children: [_jsx("div", { className: "ModalsPortal__backdrop" }), _jsx("div", { className: "ModalsPortal__container container p-5", style: styleCustom, children: element })] }), elRef.current);
};
/**
 * Default export
 */
