...
const NavDropdown = ({ label, routesArr }) => {
    ...
    return (_jsxs("div", { className: "NavDropdown user-select-none", onMouseLeave: () => setStateForClassNames(false), children: [_jsxs("div", { className: state.classNames.NavDropdownBtn.join(" "), onMouseEnter: () => setStateForClassNames(true), children: [_jsx("span", { children: label }), _jsx("i", { className: "NavDropdown__btn-arrow bi bi-caret-down-fill" })] }), _jsxs("div", { className: state.classNames.NavDropdownMenuWrapper.join(" "), children: [_jsx("div", { className: "NavDropdown__menu-underline" }), _jsx("div", { className: "NavDropdown__menu", children: routesArr.map((route, idx) => {
                            return (_jsx("div", { className: "NavDropdown__menu-btn", children: _jsx(Link, { to: route.path, children: route.label }) }, idx));
                        }) })] })] }));
};
