...
const FileUploaderComponent = ({ handleFile, labelButton, disabled = false, acceptFile = "*", prevFile = undefined, formik, name, isRequired = false, initFileInput }) => {
    ...
    const getFileElement = (newFile) => {
        return (newFile &&
            _jsxs(_Fragment, { children: [_jsx("div", { className: "col-auto my-auto", children: _jsx("label", { children: newFile.name }) }), _jsx("div", { className: "col-auto my-auto", children: _jsx("i", { className: "bi bi-trash FileUploaderComponent__trash-icon", onClick: () => delFile() }) })] }));
    };
    return (_jsxs("div", { className: "d-flex flex-row", children: [_jsxs("button", { className: "btn btn-outline-primary d-flex d-inline me-2", onClick: () => handleClick(), disabled: disabled, children: [_jsx("i", { className: "bi bi-upload me-2" }), _jsx("span", { className: isRequired ? "FileUploaderComponent__upload-btn_required" : "", children: labelButton })] }), _jsx("input", { type: "file", ref: hiddenFileInput, accept: acceptFile, onChange: (e) => handleChange(e), className: "d-none", value: "" }), formik ? getFileElement(formik === null || formik === void 0 ? void 0 : formik.values[name ? name : "file"]) : getFileElement(file)] }));
};
