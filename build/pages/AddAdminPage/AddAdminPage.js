...
const AddAdminPage = () => {
    ...
    return (_jsxs("div", { children: [_jsx(PageTitle, { title: "Nomina profilo Admin" }), _jsx(PageDescription, { description: "Di seguito puoi indicare una mail per un nuovo profilo admin" }), _jsxs("div", Object.assign({ className: "row d-flex align-items-center mt-4" }, { children: [_jsx("div", Object.assign({ className: "col-auto" }, { children: _jsx(InputTextComponent, { name: "email", label: "Email", type: "email", value: emailToAdd, isRequired: true, onChange: (name, value) => {
                                setEmailToAdd(value);
                            } }) })), _jsx("div", Object.assign({ className: "col-auto" }, { children: _jsx("button", Object.assign({ className: "Button-style btn btn-primary b-0 me-auto", disabled: !emailRegex.test(emailToAdd), onClick: () => {
                                addAdminFunction();
                            } }, { children: "Aggiungi Admin" })) }))] })), _jsxs("div", Object.assign({ className: "mt-4" }, { children: [_jsx(PageSubtitle, { subtitle: "Admin presenti" }), _jsx(ReactTable, { columns: columns, data: data, hasPagination: true, initialState: { pageSize: 5, pageIndex: 0 }, border: true, hasSorting: true })] }))] }));
};
