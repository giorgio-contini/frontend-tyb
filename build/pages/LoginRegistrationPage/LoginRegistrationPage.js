...
const LoginRegistrationPage = () => {
    ...
    return (_jsxs("div", Object.assign({ className: "row" }, { children: [_jsx("div", Object.assign({ className: "col-6 hide-on-sm mt-4" }, { children: _jsx("img", { src: "https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp", className: "img-fluid", alt: "image" }) })), _jsxs("div", Object.assign({ className: " col-sm-12 col-md-12 col-lg-6 p-2 mt-4" }, { children: [_jsx(ToggleButtonComponent, { flag: isLogin, setFlag: setLogin, option1: "Accedi", option2: "Registrati", functionToReset: resetFormikForm }), _jsxs("div", Object.assign({ className: "tab-content" }, { children: [_jsx("div", Object.assign({ className: "tab-pane fade show " + (isLogin ? "active" : ""), id: "pills-login", role: "tabpanel", "aria-labelledby": "tab-login" }, { children: _jsxs("div", Object.assign({ className: "form p-5" }, { children: [_jsx(InputTextComponent, { label: "Username", name: "username", isRequired: true, formik: formik }), _jsx(InputTextComponent, { label: "Password", type: "password", name: "password", formik: formik, isRequired: true }), _jsx("div", Object.assign({ className: "flex-row mb-4" }, { children: _jsx("div", Object.assign({ className: "d-flex justify-content-center" }, { children: _jsx("a", Object.assign({ className: "fa-underline", style: { cursor: "pointer" } }, { children: "Password dimenticata?" })) })) })), _jsx("button", Object.assign({ type: "submit", className: "btn btn-primary btn-block mb-4", onClick: () => {
                                                formik.handleSubmit();
                                            } }, { children: "Accedi" })), _jsx("div", Object.assign({ className: "text-center mt-3" }, { children: _jsxs("p", { children: ["Non sei registrato? ", _jsx("a", Object.assign({ className: "fa-underline", style: { cursor: "pointer" }, onClick: handleTabChanges }, { children: "Registrati" }))] }) }))] })) })), _jsx("div", Object.assign({ className: "tab-pane fade show " + (!isLogin ? "active" : ""), id: "pills-register", role: "tabpanel", "aria-labelledby": "tab-register" }, { children: _jsxs("div", Object.assign({ className: "form p-5" }, { children: [_jsxs("div", Object.assign({ className: "d-flex flex-row justify-content-around mb-3" }, { children: [_jsx(CheckboxComponent, { name: "typeP", label: "Admin", checked: isAdmin, onChange: () => {
                                                        setIsAdmin(true);
                                                    } }), _jsx(CheckboxComponent, { name: "typeS", label: "Studente", checked: !isAdmin, onChange: () => {
                                                        setIsAdmin(false);
                                                    } })] })), _jsx(InputTextComponent, { id: "username_reg", name: "username", label: "Username", type: "text", formik: formik, isRequired: true }), _jsx(InputTextComponent, { name: "email", label: "Email", type: "email", isRequired: isAdmin, formik: formik }), _jsx(InputTextComponent, { name: "name", label: "Nome", type: "text", formik: formik }), _jsx(InputTextComponent, { name: "surname", label: "Cognome", type: "text", formik: formik }), _jsx(InputTextComponent, { id: "password_reg", name: "password", label: "Password", type: "password", isRequired: true, formik: formik }), _jsx("button", Object.assign({ type: "submit", onClick: () => formik.handleSubmit(), className: "btn btn-primary btn-block mb-3 mt-5" }, { children: "Conferma" }))] })) }))] }))] }))] })));
};
