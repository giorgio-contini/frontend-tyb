...
const QuizPage = () => {
    ...
    return _jsxs("div", { children: [_jsxs("div", Object.assign({ className: "d-flex flex-row justify-content-between p-2", style: { alignItems: "center" } }, { children: [_jsx("h3", { children: (_a = topic === null || topic === void 0 ? void 0 : topic.toUpperCase()) !== null && _a !== void 0 ? _a : "" }), _jsx(TimerComponent, { onTimeout: handleTimeout, remainingTime: remainingTime, setRemainingTime: setRemainingTime }), _jsxs("h6", { children: [" ", 'Domanda ' + (currentQuestionIndex + 1) + " di " + (questions === null || questions === void 0 ? void 0 : questions.length)] })] })), _jsxs("div", Object.assign({ className: "pageContainer mt-5" }, { children: [_jsx("div", Object.assign({ className: "questionContainer d-flex justify-content-center" }, { children: imagesType ? _jsx("img", { src: (_b = questions[currentQuestionIndex]) === null || _b === void 0 ? void 0 : _b.description, alt: "image" }) :
                            _jsx("h2", { children: ((_c = questions[currentQuestionIndex]) === null || _c === void 0 ? void 0 : _c.description) || "" }) })), _jsx("div", Object.assign({ className: "answerGrid mt-4" }, { children: shuffledAnswers === null || shuffledAnswers === void 0 ? void 0 : shuffledAnswers.map((el, index) => {
                            return _jsx("button", Object.assign({ className: 'answerButton ' + getStyle(el.description), onClick: () => {
                                    var _a;
                        ...
                        }) }))] })), _jsx("div", Object.assign({ className: "d-flex flex-row mt-5" }, { children: 
                //currentQuestionIndex != questions.length-1?
                _jsx("div", Object.assign({ className: "ms-auto" }, { children: _jsx("button", Object.assign({ className: "btn btn-outline-secondary", onClick: loadNextQuestion }, { children: "Avanti" })) })) }))] });
};
