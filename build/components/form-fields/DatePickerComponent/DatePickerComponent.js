...
const DatePickerComponent = ({ name, label, dateFormat, selected, disabled = false, onChange, isRequired, formik }) => {
    ...
    return (_jsxs("div", Object.assign({ className: "DatePickerComponent" }, { children: [_jsx("label", Object.assign({ className: classNames["DatePickerComponent__label"].join(" "), htmlFor: name }, { children: label })), _jsxs("label", Object.assign({ className: "DatePickerComponent__labelIconWrapper", onClick: e => e.preventDefault() }, { children: [_jsx(DatePicker, { dateFormat: dateFormat, selected: formik ? formik.values[name] : selected, id: name, onChange: (date) => {
                        ...
                        }, disabled: disabled, shouldCloseOnSelect: true, className: fieldError ? " error " : "" }), _jsx("i", { className: "bi bi-calendar4" })] })), _jsx("div", Object.assign({ className: "Validation__errorMessage small p-0" }, { children: fieldError ? fieldError : "" }))] })));
};
