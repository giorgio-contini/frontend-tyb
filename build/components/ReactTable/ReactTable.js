...
function getHeaderRow(headerGroup, props) {
    return _jsx("tr", Object.assign({}, headerGroup.getHeaderGroupProps(), { children: headerGroup.headers.map((column) => props.hasSorting === true ? (_jsx("th", Object.assign({ className: `${props.border
                ? "ReactTable__border"
                : ""}` }, column.getHeaderProps(column.getSortByToggleProps()), { children: _jsxs("div", Object.assign({ className: "TableClassic__thead_th-flex" }, { children: [(column === null || column === void 0 ? void 0 : column.Header) ? column.render("Header") : "", column.Header &&
...
function getPageComponent(canPreviousPage, previousPage, pageIndex, canNextPage, nextPage) {
    return _jsxs(_Fragment, { children: [canPreviousPage ? (_jsx("button", Object.assign({ onClick: () => previousPage() }, { children: pageIndex }))) : null, _jsx("button", Object.assign({ className: "ReactTable__pagination-PageIndices-CurrentIndex" }, { children: pageIndex + 1 })), canNextPage ? (_jsx("button", Object.assign({ onClick: () => nextPage() }, { children: pageIndex + 2 }))) : null] });
}
/**
