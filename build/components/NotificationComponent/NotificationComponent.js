...
const NotificationComponent = ({ type, messages, className, show = true, closable, children, cbClose, noIcon }) => {
    ...
    return (_jsx("div", Object.assign({ className: classNames["NotificationComponent"].join(" ") }, { children: _jsxs("div", Object.assign({ className: classNames["NotificationComponent__notify"].join(" "), role: "alert", "aria-labelledby": "text_notify", id: "notify" }, { children: [_jsxs("div", Object.assign({ id: "text_notify", className: "NotificationComponent__flex" }, { children: [!noIcon ? _jsx("i", { className: classNames["NotificationComponent__icon"].join(" ") }) : null, _jsx("div", Object.assign({ className: "d-flex flex-column" }, { children: messages.map((message, index) => {
                                return message ? _jsx("div", Object.assign({ className: "d-flex justify-content-center align-items-center w-100" }, { children: _jsx("h6", Object.assign({ className: "m-0 ms-2 w-100 text-break" }, { children: message })) }), "message" + index) : _jsx(_Fragment, {});
                            }) })), closable ? _jsx("button", Object.assign({ className: "btn ms-auto", onClick: cbClose }, { children: _jsx("i", { className: "bi bi-x-lg" }) })) : null] })), children] })) })));
};
