...
export const useHeaderRoutes = () => {
    ...
    function genHeaderRoutesArr() {
        ...
        const headerRoutesArrStudents = [homeRoute, statisticheRoute];
        //const headerRoutesArrProfessors: headerRoute[] = [homeRoute, statisticheRoute, addQuiz];
        const headerRoutesArrAdmin = [homeRoute, statisticheRoute, addQuiz, addAdmin];
        const initialRoutes = [welcomeRoute];
        if (isInRole("S")) {
